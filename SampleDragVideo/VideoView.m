...
@interface VideoView()<UIGestureRecognizerDelegate, UITableViewDelegate, UITableViewDataSource>
...
//        greenView = [[UIView alloc]initWithFrame:CGRectMake(0, h_View * 2/5, w_View, h_View *3/5)];
        parentGreenView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, w_View, h_View)];
        
        videoView.backgroundColor = [UIColor clearColor];
//        greenView.backgroundColor = [UIColor greenColor];
        
        tbView = [[UITableView alloc]initWithFrame:CGRectMake(0, h_View * 2/5, w_View, h_View *3/5)];
        tbView.delegate = self;
        tbView.dataSource = self;
        
        [parentGreenView addSubview:tbView];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *textLabelTitle = [NSString stringWithFormat:@"Commend %ld", (long)indexPath.row];
